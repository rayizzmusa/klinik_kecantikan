...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql2 = "select * from treatment where id_layanan=\"$service\" and jam=\"$time\" and hapus=0";
    ...
    if ($error == 0) {
        $sql3 = "insert into transaction (id_user, username, id_treatment, id_layanan, hapus, created_at) values ($id_user, \"$name\", $id_treatment, \"$service\", 0, NOW())";
