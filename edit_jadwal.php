...
$jam = [];
$sql = "SELECT id, jam FROM treatment WHERE layanan=\"$service\" AND hapus=0";
...
<body>
    <div id="payment" class="page active">
            ...
            <?php if ($ndata > 0): ?>
                <?php foreach ($jam as $j): ?>
                    <div class="jam-item">
                        ...
                        <form action="hapus_jam.php" method="POST" style="margin:0;">
        ...
        <section>
            ...
            <form action="tambah_jam.php" method="POST">
                <input type="hidden" name="service" value="<?= $service ?>">
                <input type="time" name="time" step="900" min="08:00" max="19:00" required>
